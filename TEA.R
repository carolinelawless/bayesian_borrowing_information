...
length(which(S_H1_1 < threshold))/length(S_H1_1) #0.491 #0.461 0.461
...
# Check how often S_H1 < threshold to estimate power
length(which(S_H1_2 < threshold))/length(S_H1_2) #0.76 0.723 0.71

length(which(S_H1_2 < threshold))/length(S_H0_2) #0.723
